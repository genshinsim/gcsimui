...
<div class="bg-gray-700 p-2 rounded-md shadow edit-content">
    ...
    <div>
        ...
        <p>
            The sim runs on a text based config file. For more help on the
            config file itself, see <a
                href="#"
                on:click={() => {
                    open(
                        "https://github.com/genshinsim/gsim/wiki/Configuration"
                    );
                }}>wiki</a
            >.
        </p>
        ...
        <p>
            ...
            will have to be written in the text format still. For more
            information on the action list itself, see <a
                href="#"
                on:click={() => {
